Source from the following GitHub repo
https://github.com/artic-network/artic-ncov2019/tree/master/primer_schemes/nCoV-2019/V4.1

This primer scheme is an update to the V4 scheme which restores the funtionality of some primers against the Omicron variant. The following changes are made;
